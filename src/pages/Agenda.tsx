    ...
    <div className="space-y-6 animate-fade-in-up">
      ...
      <div className="grid lg:grid-cols-[350px_1fr] gap-6 items-start print:block">
        ...
        <div className="space-y-6 print:hidden">
          <Card className="shadow-sm border-border/60 h-auto min-h-fit overflow-visible">
            <CardContent className="p-3 flex justify-center overflow-visible h-auto min-h-fit [&_td]:flex-1 [&_th]:flex-1 [&_.rdp-months]:w-full [&_.rdp-months]:min-h-fit [&_.rdp-months]:h-auto [&_.rdp-month]:w-full [&_.rdp-month]:min-h-fit [&_.rdp-month]:h-auto [&_.rdp-table]:w-full [&_.rdp-table]:min-h-fit [&_.rdp-table]:h-auto [&_.rdp]:h-auto">
              <Calendar
                mode="single"
                locale={ptBR}
                formatters={{
